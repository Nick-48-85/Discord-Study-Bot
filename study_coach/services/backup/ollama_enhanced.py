"""
Enhanced service for interacting with the Ollama API, with improved temperature handling.
"""
...
class OllamaEnhancedService:
    """Enhanced service for interacting with the Ollama API."""
            ...
            if start_idx >= 0 and end_idx > start_idx:
                ...
                try:
                    ...
                    try:
                        ...
                        print(f"Secondary parsing error: {str(e2)}")
                        # Create a fallback flashcard to show something
